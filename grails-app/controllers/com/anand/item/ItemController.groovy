...
class ItemController {
	...
	def saveItem(){
		...
		for(int i = 1; i<10;i++){
			...
			Item item = new Item(itemName: "mens"+i,itemCode : "IT9",itemDescription: "black",itemBrand : "Sparx",itemType: "mens",itemPrice: 20.00,discountRate:0.00,quantity:2,qtyOrdered:0,isItemDiscountable: false,itemSize : "8", itemColor : "brown",isNew :true,rating :4)
