...
function display(view)
{
	if (view == 'list')
	{
		...
		$('.product_list > li').removeClass(' col-sm-6 col-md-4').addClass(' ');
		$('.product_list > li').each(function(index, element) {
			html = '';
			html = '<div class="product-container"><div class="row">';
				html += '<div class="left-block col-sm-4 col-md-4">' + $(element).find('.left-block').html() + '</div>';
				html += '<div class="center-block col-sm-4 col-md-4">';
				...
				html += '</div>';	
				html += '<div class="right-block col-sm-4 col-md-4"><div class="right-block-content row">';
					var price = $(element).find('.content_price').html();       // check : catalog mode is enabled
					if (price != null) { 
						html += '<div class="content_price  col-sm-12">'+ price + '</div>';
					}
	...
	else 
	{
		...
		$('.product_list > li').removeClass('col-xs-12').addClass(' col-sm-6 col-md-4');
		$('.product_list > li').each(function(index, element) {
		html = '';
